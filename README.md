...
```bash
> docker run --rm -p "8009:8009" becorecode/curso-intro-docker-modulo-9:latest
```

Una vez levantado el contenedor, accede con un navegador web a `http://localhost:8009`
...
* Para imprimirlas:
  * Accede a la URL `http://localhost:8009/?print-pdf`
  * Imprime la página 
  * Si deseas añadir las notas del presentador utiliza la URL  `http://localhost:8009/?print-pdf&showNotes=true`
